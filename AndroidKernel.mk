...
#+chk34614 ,laiwenqiang.wt,ADD,2019.10.24,open KERNEL debug feature Root,begin
#+chk37874 ,laiwenqiang.wt,ADD,2019.10.24,open rtb in FC stage,begin
ifneq ($(WT_FINAL_RELEASE),yes)
...
KERNEL_CONFIG_OVERRIDE += CONFIG_CORESIGHT_DBGUI=y
...
#-chk37874 ,laiwenqiang.wt,ADD,2019.10.24,open rtb in FC stage,end
#-chk34614 ,laiwenqiang.wt,ADD,2019.10.24,open KERNEL debug feature Root,end
...
$(KERNEL_OUT):
	mkdir -p $(KERNEL_OUT)
#+chk34614 ,laiwenqiang.wt,MODIFY,2019.10.24,open KERNEL debug feature Root,begin
...
#-chk34614 ,laiwenqiang.wt,MODIFY,2019.10.24,open KERNEL debug feature Root,end
ifeq ($(TARGET_KERNEL_APPEND_DTB), true)
